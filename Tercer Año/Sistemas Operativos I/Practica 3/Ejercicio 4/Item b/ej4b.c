...
/*
Que varios lectores intenten leer el arreglo puede llevar a un starvation de los escritores ya que 
si hay ya un lector leyendo el arreglo, al tener prioridad ellos, si aparece otro lector va a 
leer el arreglo con ellos. El escritor que quiera escribir en el arreglo no podrá ya que cada vez
van entrando más escritores, generando starvation.
*/